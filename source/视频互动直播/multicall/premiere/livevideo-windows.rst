...
::
        ...
        public void setCustomRole(int customRole, JCMediaChannelParticipant participant)
...
.. list-table::
   ...
   * - JOIN_PARAM_MAX_RESOLUTION = "maxResolution"
     - 最大分辨率，参考 JCMediaChannelMaxResolution 枚举值
...
::
    ...
    public void joinRoom(JCMediaChannelCustomRole customRole) {
        ...
        if (needsPassword) {//需要密码
           joinparams.Add(JCMediaChannelConstants.JOIN_PARAM_PASSWORD, "123456");
        }
        //加入直播
...
`JCClient <http://developer.juphoon.com/portal/reference/windows/html/7d4a1961-552c-2ad5-9a54-74222c4135a3.htm>`_  ：登录模块，用于登录登出管理及账户属性存储

`JCMediaDevice <http://developer.juphoon.com/portal/reference/windows/html/034d5af6-ec04-5148-7ec5-04e27e93e8c2.htm>`_  ：设备模块，用于音视频设备管理

`JCMediaChannel <http://developer.juphoon.com/portal/reference/windows/html/8289e4bf-8045-497b-f584-fc76cad8f8a1.htm>`_  ：媒体频道模块，类似音视频房间的概念，可以通过频道号加入频道进行音视频通话
...
client 为 `JCClient <http://developer.juphoon.com/portal/reference/windows/html/7d4a1961-552c-2ad5-9a54-74222c4135a3.htm>`_ 实例
...
mediaChannel 为 `JCMediaChannel <http://developer.juphoon.com/portal/reference/windows/html/8289e4bf-8045-497b-f584-fc76cad8f8a1.htm>`_  实例

`JCMediaChannelParticipant <http://developer.juphoon.com/portal/reference/windows/html/8ad58616-3028-b8d3-8106-81b8b805c1ea.htm>`_ ：媒体频道成员
...
`JCMediaDeviceVideoCanvas <http://developer.juphoon.com/portal/reference/windows/html/6a5b853c-d890-c30e-d236-5728d789ace1.htm>`_ ：视频对象，用于UI层处理视频

FULLCONTENT：视频内容全显示，渲染模式选择参考 `JCMediaDeviceRenderMode <http://developer.juphoon.com/portal/reference/windows/html/44604552-33eb-5a81-6b10-6c512d127a4b.htm>`_
...
JCMediaChannelPictureSize.Large 为视频大尺寸，更多视频尺寸参见 `JCMediaChannelPictureSize <http://developer.juphoon.com/portal/reference/windows/html/a8c3f23e-c3b9-ce29-b594-412995b0e4ca.htm>`_
...
mediaDevice 为 `JCMediaDevice <http://developer.juphoon.com/portal/reference/windows/html/034d5af6-ec04-5148-7ec5-04e27e93e8c2.htm>`_ 实例

canvas 为 `JCMediaDeviceVideoCanvas <http://developer.juphoon.com/portal/reference/windows/html/6a5b853c-d890-c30e-d236-5728d789ace1.htm>`_ 实例
